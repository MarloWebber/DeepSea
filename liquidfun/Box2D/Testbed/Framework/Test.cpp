...
void Test::jointMotorSetpoint()
{
	...
	// b2Joint alljoints[] = m_world->GetJointList();
	// int n_joints = m_world->GetJointCount();

	// for (int i = 0; i < n_joints; i++) {
	// 	int * mulagh = (int*)alljoints[i].GetUserData();
	// 	int bralackh = *mulagh;
	// 	if ( bralackh == 909) {
	// 		b2RevoluteJoint* managg = (b2RevoluteJoint* )&alljoints[i];
	// 		float penuous = managg->GetMotorSpeed();
	// 		managg->SetMotorSpeed(-1 * penuous);
	// 	}
	// }
	...
	// for (int i = 0; i < n_joints; i++) {
		// void * malal = m_world->GetJointList()[i].GetUserData();
	// 	int bralackh = *mulagh;
	// 	if ( bralackh == 909) {
	// 		// alljoints[i].enableMotor = false;
	//         b2RevoluteJoint* revoluteJoint = (b2RevoluteJoint*)&m_world->GetJointList()[i];
